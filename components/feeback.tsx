...
const Feeback: NextPage<FeebackType> = ({ className = "" }) => {
  return (
    ...
    >
      <div className="w-[544px] flex flex-col items-center justify-start py-5 px-0 box-border gap-[115px] min-w-[544px] max-w-full lg:flex-1 mq825:gap-[57px] mq825:min-w-full mq450:gap-[29px]">
        ...
        <div className="w-[471px] rounded-xl bg-white flex flex-col items-start justify-start p-2.5 box-border max-w-full text-left text-base">
