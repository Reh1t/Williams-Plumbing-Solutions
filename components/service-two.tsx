...
const ServiceTwo: NextPage<ServiceTwoType> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="h-[207px] w-[650px] flex flex-col items-start justify-start min-w-[650px] max-w-full mq825:min-w-full mq1400:flex-1">
        <img
          ...
          loading="lazy"
          alt=""
          src="/williams-install-5-resizedpng@2x.png"
        />
      </div>
    </div>
  );
