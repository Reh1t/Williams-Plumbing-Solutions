...
const PanelImageContent: NextPage<PanelImageContentType> = ({
  ...
  return (
    ...
    >
      <img
        className="h-[351px] w-[484px] overflow-hidden shrink-0 object-contain min-h-[351px] max-w-full mq1425:flex-1"
        alt=""
        src="/image-6@2x.png"
        data-scroll-to="scroller"
      />
      <div className="w-[828px] flex flex-col items-center justify-center py-[77px] px-2.5 box-border gap-[24px] min-w-[828px] max-w-full lg:min-w-full mq450:pt-[50px] mq450:pb-[50px] mq450:box-border mq1425:flex-1">
